...
* Reject scanning binary format values into a string (e.g. binary encoded timestamptz to string). See https://github.com/jmcoelloidonia/pgx/issues/219 and https://github.com/jmcoelloidonia/pgx/issues/228
