...
import (
	...
	_ "github.com/jmcoelloidonia/pgx/stdlib"
	_ "github.com/lib/pq"
)
...
func MustConnectDatabaseSQL(t testing.TB, driverName string) *sql.DB {
	...
	case "github.com/jmcoelloidonia/pgx/stdlib":
		sqlDriverName = "pgx"
	default:
...
func TestSuccessfulTranscodeEqFunc(t testing.TB, pgTypeName string, values []interface{}, eqFunc func(a, b interface{}) bool) {
	...
	for _, driverName := range []string{"github.com/lib/pq", "github.com/jmcoelloidonia/pgx/stdlib"} {
