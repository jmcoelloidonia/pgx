...
func convertSimpleArgument(ci *pgtype.ConnInfo, arg interface{}) (interface{}, error) {
	...
	// https://github.com/jmcoelloidonia/pgx/issues/409 Changed JSON and JSONB to surface
	...
	// case because of https://github.com/jmcoelloidonia/pgx/issues/339. So instead we
